async function get_aritcle_content(page, link) {
    const article_value = {
        title: '',
        time: '',
        overview: '',
    ...
    const xpath_title =
        '::-p-xpath(/html/body/main/div[3]/div[2]/div[1]/article[1]/h1)';
    const xpath_time =
        '::-p-xpath(/html/body/main/div[3]/div[2]/div[1]/article[1]/div[1]/div[2]/time)';
    const xpath_overview =
        '::-p-xpath( /html/body/main/div[3]/div[2]/div[1]/article[1]/h2)';
    const xpath_content =
        '::-p-xpath( /html/body/main/div[3]/div[2]/div[1]/article[1]/div[3])';
...
export default get_aritcle_content;
